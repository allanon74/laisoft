...
class Base_a(TranslatableModel):
...
class Periodic_a(TranslatableModel):
...
class Description_a(TranslatableModel):
...
class ValidDate_a(TranslatableModel):
...
class Status_a(TranslatableModel):
...
class RABS_a(TranslatableModel):
